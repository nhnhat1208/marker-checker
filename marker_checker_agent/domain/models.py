...
from marker_checker_agent.domain.enums import (
    ActorKind,
    AuditEventType,
    ConversationRole,
    Operation,
...
class RequestRecord(BaseModel):
    ...
    @field_validator(
        "requester_name", "approver_name", "target_object_type", "business_reason",
...
class AuditEventRecord(BaseModel):
    ...
    source_channel: Literal["telegram"] = "telegram"
    thread_id: str | None = None
    source_message_id: str | None = None
    ...
    @classmethod
    def _parse_source_channel(cls, v: object) -> Literal["telegram"]:
        return "telegram"
